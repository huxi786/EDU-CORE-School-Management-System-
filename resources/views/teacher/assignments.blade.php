                    ...
                    <div class="bg-white rounded-3xl shadow-lg border border-slate-100 overflow-hidden flex flex-col hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
                        <div class="bg-gradient-to-r from-slate-900 to-slate-800 p-6 text-white relative">
                            ...
                            <div class="relative z-10">
                                ...
                                <h3 class="text-2xl font-black text-white group-hover:text-indigo-300 transition-colors line-clamp-1">{{ $assignment->title }}</h3>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-50 p-4 border-t border-slate-100 flex gap-2">
                            <button class="flex-1 bg-white border border-slate-200 hover:border-indigo-300 hover:text-indigo-600 text-slate-600 text-sm font-bold py-2.5 rounded-xl transition-colors shadow-sm">View Details</button>
                            <button class="w-12 flex items-center justify-center bg-white border border-slate-200 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 text-slate-400 rounded-xl transition-colors shadow-sm">
                ...
                @empty
                    <div class="col-span-full py-24 text-center bg-white rounded-[2rem] border border-slate-200 shadow-sm">
                        <div class="w-24 h-24 mx-auto bg-indigo-50 rounded-full flex items-center justify-center mb-4">
                            <svg class="w-10 h-10 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                        </div>
